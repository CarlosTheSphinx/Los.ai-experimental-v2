...
const NQX_DEFAULTS: ExternalPricingConfig = {
  ...
  dropdowns: [
    { label: 'LTV', fieldKey: 'ltv', options: ['≤ 50%', '50.01% - 55%', '55.01% - 60%', '60.01% - 65%', '65.01% - 70%', '70.01% - 75%', '75.01% - 80%'], sourceType: 'default' as FieldSourceType },
    { label: 'Loan Type', fieldKey: 'loanType', options: ['30 YR Fixed Rate', '10/6 ARM (30 YR)', '7/6 ARM (30 YR)', '5/6 ARM (30 YR)'], sourceType: 'default' as FieldSourceType },
    { label: 'Interest Only', fieldKey: 'interestOnly', options: ['Yes', 'No'], sourceType: 'default' as FieldSourceType },
    { label: 'Loan Purpose', fieldKey: 'loanPurpose', options: ['Purchase', 'Rate/Term Refinance', 'Cash Out Refinance'], sourceType: 'default' as FieldSourceType },
    { label: 'Property Type', fieldKey: 'propertyType', options: ['Single Family Residence', 'Condo (Warrantable)', 'Condo (Non-Warrantable)', '2-4 Unit', 'Multifamily (5+ Units)'], sourceType: 'default' as FieldSourceType },
    { label: 'Est. DSCR', fieldKey: 'dscr', options: ['≥ 1.50', '1.25 - 1.49', '1.00 - 1.24', '0.75 - 0.99', '< 0.75', 'No Ratio'], sourceType: 'default' as FieldSourceType },
    { label: 'Stated FICO Score', fieldKey: 'ficoScore', options: ['≥ 780', '760 - 779', '740 - 759', '720 - 739', '700 - 719', '680 - 699', '660 - 679'], sourceType: 'default' as FieldSourceType },
    { label: 'Prepayment Penalty', fieldKey: 'prepaymentPenalty', options: ['5 Years', '4 Years', '3 Years', '2 Years', '1 Year', 'None'], sourceType: 'default' as FieldSourceType },
    { label: 'TPO Premium', fieldKey: 'tpoPremium', options: ['1', '2', '3'], sourceType: 'default' as FieldSourceType },
  ],
};
