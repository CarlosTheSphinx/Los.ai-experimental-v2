...
import { Loader2, AlertCircle, Calculator, FileText, Briefcase } from "lucide-react";
...
export default function JoinBrokerPage() {
  const [, params] = useRoute("/join/broker/:token");
                      ...
                      <CardContent>
                        ...
                        {deal.portalToken && (
                          <Button
                            ...
                            size="sm"
                            className="mt-3"
                            onClick={() => window.location.href = `/broker-portal/${deal.portalToken}`}
                          >
                            View Deal Portal
                          </Button>
                        )}
